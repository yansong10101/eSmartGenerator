...
DAO_FUNCTION_INSERT_FIELD = json_data[JSON_TOP_NODE_SOURCE_TEMPLATE]['insert_field']
DAO_FUNCTION_INSERT_VALUE = json_data[JSON_TOP_NODE_SOURCE_TEMPLATE]['insert_value']
DAO_FUNCTION_UPDATE = json_data[JSON_TOP_NODE_SOURCE_TEMPLATE]['update_field']
DAO_FUNCTION_FILL = json_data[JSON_TOP_NODE_SOURCE_TEMPLATE]['fill_template']
DAO_FUNCTION_SAVE = json_data[JSON_TOP_NODE_SOURCE_TEMPLATE]['save_template']
DAO_FUNCTION_SETUP = json_data[JSON_TOP_NODE_SOURCE_TEMPLATE]['setup_template']
